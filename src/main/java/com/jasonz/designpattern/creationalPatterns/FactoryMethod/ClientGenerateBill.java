...
import creationalPatterns.FactoryMethod.ElectricityBillExample.GetPlanFactory;
import creationalPatterns.FactoryMethod.ElectricityBillExample.Plan;
...
public class ClientGenerateBill
{
			...
			throws NumberFormatException, IOException
	{
		...
		System.out.print(
				"Enter the name of plan for which the bill will be generated: ");
